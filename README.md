...
- Add at least 2 screenshots:
  ...
  - Main/dashboard screen (showing data + PDF preview)
- Short demo video (30–60s) showing: login → create item → offline mode → sync → PDF export.

## How to contribute
- Fork, create a feature branch, open a PR with tests and a short summary.
- Follow existing `flutter_bloc` patterns and naming conventions.

---

If you'd like, I can also:
- Add screenshots and a demo GIF to the README,
- Commit the change and create a GitHub release.
